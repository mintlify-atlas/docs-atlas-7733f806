...
description: "All activation functions available in Neural Network Framework: Sigmoid, ReLU, Tanh, Softmax, and linear. Includes formulas, derivatives, and recommended use cases."
---
