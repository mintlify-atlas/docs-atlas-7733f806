...
description: "Neural Network Framework is a from-scratch NumPy neural network library. Learn what it provides, its architecture, and when to use it over heavier frameworks."
---
