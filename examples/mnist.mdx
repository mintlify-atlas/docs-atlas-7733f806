...
sidebarTitle: "MNIST"
description: "Train a 4-layer feedforward network on MNIST handwritten digits using Neural Network Framework, ReLU hidden layers, softmax output, and cross-entropy."
---
